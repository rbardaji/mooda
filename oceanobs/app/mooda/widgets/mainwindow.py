...
class MOODA(QMainWindow):
    ...
    def initUI(self):
        ...
        # -- New project --
        newAct = QAction(QIcon('oceanobs\\app\\mooda\\icon\\new.png'),
                         '&New project', self)
        ...
        # -- Open --
        openAct = QAction(QIcon('oceanobs\\app\\mooda\\icon\\open.svg'),
                          '&Open', self)
        ...
        # -- Add --
        addAct = QAction(QIcon('oceanobs\\app\\mooda\\icon\\add.svg'),
                         '&Add', self)
        addAct.setStatusTip('Add data to the current dataset')
        addAct.triggered.connect(lambda: self.openFile(concat=True))
        fileMenu.addAction(addAct)
        # --- EGIM downloader ---
        downloaderAct = QAction(QIcon('oceanobs\\app\\mooda\\icon\\cloud.png'),
        ...
        # --- Save as ---
        self.saveAct = QAction(QIcon('oceanobs\\app\\mooda\\icon\\save.png'),
                               '&Save as...', self)
        ...
        fileMenu.addSeparator()
        # -- Exit --
        exitAct = QAction(QIcon('oceanobs\\app\\mooda\\icon\\exit.svg'),
                          'E&xit', self)
        ...
        # --- Auto QC ---
        self.qcAutoAct = QAction(QIcon('oceanobs\\app\\mooda\\icon\\qc.png'),
                                 '&Auto', self)
        ...
        self.deleteAct = QAction(QIcon(
            'oceanobs\\app\\mooda\\icon\\delete.png'), '&Remove parameters',
                                 self)
        ...
        self.renameAct = QAction(QIcon(
            'oceanobs\\app\\mooda\\icon\\rename.png'), 'Re&name parameters',
                                 self)
        ...
        self.resampleAct = QAction(QIcon(
            'oceanobs\\app\\mooda\\icon\\resample.png'), 'Resam&ple data',
                                   self)
        self.resampleAct.triggered.connect(self.plotArea.resampleWidget.show)
        dataMenu.addAction(self.resampleAct)
        # -- Slice data --
        self.sliceAct = QAction(QIcon('oceanobs\\app\\mooda\\icon\\slice.png'),
                                '&Slice data', self)
        ...
        # -- Datalog --
        datalogAct = QAction(QIcon('oceanobs\\app\\mooda\\icon\\log.png'),
                             '&Datalog', self)
        ...
        self.metadataAct = QAction(QIcon(
            'oceanobs\\app\\mooda\\icon\\metadata.png'), '&Metadata', self)
        ...
        self.dataViewAct = QAction(QIcon(
            'oceanobs\\app\\mooda\\icon\\graph.png'), '&Parameters', self)
        ...
        self.setWindowIcon(QIcon('oceanobs\\app\\mooda\\icon\\mooda.png'))
