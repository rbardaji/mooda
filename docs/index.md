...
*oceanobs* code is designed to be open, adaptable and scalable allowing future contributions from researchers and developers from all the disciplines associated to the marine observatories. Visit our [GitHub repository](https://github.com/rbardaji/oceanobs).